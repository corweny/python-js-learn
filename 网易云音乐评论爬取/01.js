...
lowBitMasks = new Array(0,1,3,7,15,31,63,127,255,511,1023,2047,4095,8191,16383,32767,65535);
    ...
    window.ecnonasr = e
;
j3x.wU8M = function(gI4M, VT4X, cLf4j) {
    if (!gI4M)
        return "";
    var bx3x = [];
    for (var x in gI4M) {
        bx3x.push(encodeURIComponent(x) + "=" + (!!cLf4j ? encodeURIComponent(gI4M[x]) : gI4M[x]))
    }
    return bx3x.join(VT4X || ",")
}
;
function j3x(gI4M) {
    return j3x.wU8M(gI4M, "&", !0)
}
function NEJ_F() {
    return !1
}
function NEJ_X(gI4M, bU3x, eh4l) {
    if (!gI4M || !bU3x)
        return gI4M;
    // eh4l = eh4l || NEJ_F;
    for (var x in bU3x) {
        if (bU3x.hasOwnProperty(x) && !eh4l(bU3x[x], x))
            gI4M[x] = bU3x[x]
    }
    return gI4M
}
;
function u3x_be3x(sid) {
    var i3x = {}
        i3x={
            "rid": "R_SO_4_"+sid,
        ...
        var bVi9Z = window.asrsea(JSON.stringify(i3x), '010001', '', "0CoJUm6Qyw8W8jud");
        return {
            params: bVi9Z.encText,
            encSecKey: bVi9Z.encSecKey
        }
};
function getCommentList(sid){
    return u3x_be3x(sid)
}